        ...
        <div className="flex flex-col">
           {services.map((service, idx) => (
             ...
             >
                ...
                <div className="flex items-baseline gap-6 md:gap-16 mb-6 md:mb-0">
                  <span className="text-xs md:text-sm font-mono text-gray-500 font-medium">
                    {service.id}
                  </span>
                  <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-medium text-white group-hover:translate-x-4 transition-transform duration-300">
                    {service.title}
                  </h3>
                </div>

                <div className="flex items-center gap-6 md:gap-12 md:max-w-xl w-full justify-between md:justify-end pl-8 md:pl-0">
