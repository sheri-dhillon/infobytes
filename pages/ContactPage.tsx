              ...
              <div className="bg-[#111] p-8 md:p-12 rounded-[2.5rem] border border-white/10 sticky top-32">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {submitStatus === 'success' && (
                    <div className="mt-6 rounded-xl border border-green-500/30 bg-green-500/10 px-4 py-3 text-sm text-green-200 animate-fade-in flex items-center gap-2">
                      <CheckCircle className="w-5 h-5" />
                      {submitMessage || 'Thank you for reaching out. We will get back to you shortly.'}
                    </div>
                  )}
                </form>
              </div>
