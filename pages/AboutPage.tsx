...
import { MousePointer2, Plus, ArrowUpRight, Linkedin } from 'lucide-react';
...
export const AboutPage: React.FC = () => {
  ...
  const team = [
    ...
    { 
      name: "Galloc", 
      role: "Product", 
      image: "https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?w=600&h=600&fit=crop&q=80", 
      span: "col-span-1" 
    },
    { 
      name: "HiskMz", 
      role: "Marketing", 
      image: "https://images.unsplash.com/photo-1517841905240-472988babdf9?w=600&h=600&fit=crop&q=80", 
      span: "col-span-1" 
    },
    { 
      name: "Launch", 
      role: "Operations", 
      image: "https://images.unsplash.com/photo-1520341280432-4749d4d7bcf9?w=600&h=600&fit=crop&q=80", 
      span: "col-span-1" 
    },
    {
      name: "You?",
       ...
       <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10">
          ...
          <div className="flex flex-col items-start lg:pr-6 sticky top-32">
             ...
             <p className="text-gray-400 text-lg md:text-xl max-w-lg mb-12 leading-relaxed">
                We design delightful experiences that make life simpler and more enjoyable. Our team is a collective of creative minds obsessed with quality.
             </p>
    ...
    <section className="bg-black py-20 md:py-32 px-6">
       <div className="max-w-[1200px] mx-auto">
          <div className="text-gray-500 text-sm md:text-base font-medium mb-8 flex items-center gap-3">
             ...
             We're a product design & AI studio built for real-world impact.
          </div>
          <p className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white leading-[1.25] tracking-tight font-medium max-w-6xl">
             We help teams design smarter, scale faster, and deliver better digital experiences — without the fluff. Clarity, speed, and long-term value. Whether you're building your first MVP or optimizing a complex SaaS, our work wraps around your business goals — not the other way around.
          </p>
       </div>
    </section>
