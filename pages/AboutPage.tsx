             ...
             {team.map((member, idx) => (
                member.isHiring ? (
                  ...
                  >
                     ...
                     {/* Pill Label */}
                     <div className="absolute bottom-3 left-3 md:bottom-4 md:left-4 px-3 py-1.5 md:px-4 md:py-2 bg-[#1a1a1a] rounded-full flex items-center gap-2.5 shadow-lg border border-white/5 transition-transform duration-300 group-hover:translate-y-[-2px]">
